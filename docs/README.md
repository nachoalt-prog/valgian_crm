...
- **`domain/`** — modelo de datos, organizado en un documento atómico por subsistema (core, motor de estados, infraestructura, bandejas). Misma lógica: referencia viva, se edita in-place.
